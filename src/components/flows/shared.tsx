...
> = {
  ...
  ai_condition: {
    label: 'Se / senão com IA',
    icon: BrainCircuit,
    color: 'text-purple-400',
    blurb: 'Cria caminhos conforme uma classificação da IA',
    category: 'logic',
  },
  ai_extract: {
    ...
    blurb: 'Faz uma pergunta e extrai dados com IA',
    category: 'logic',
  },
  set_tag: {
  ...
  handoff: {
    ...
    blurb: 'Entrega a conversa para uma pessoa',
    category: 'flow',
  },
  end: {
    label: 'Fim',
