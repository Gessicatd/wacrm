...
export const SECTION_META: Record<SettingsSection, SectionMeta> = {
  ...
  marketing: { id: 'marketing', label: 'Marketing e anúncios', icon: PlugZap, group: 'workspace' },
  integrations: { id: 'integrations', label: 'Integrações e pagamentos', icon: PlugZap, group: 'workspace' },
