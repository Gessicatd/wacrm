...
export default function CommercialPage() {
  ...
  return <div className="space-y-6 p-4 sm:p-6">
    <div><p className="text-sm font-medium text-primary">Health & aesthetics high-ticket</p><h1 className="mt-1 text-2xl font-bold text-foreground">Commercial command center</h1><p className="mt-1 max-w-3xl text-sm text-muted-foreground">Exceptions first: protect response time, attendance, next actions, consent and delivery handoff without storing clinical records.</p></div>
